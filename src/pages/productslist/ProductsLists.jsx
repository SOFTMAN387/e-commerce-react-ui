...
const ProductsLists = () => {
    return (
        <>
        <br></br>
         <h6 className='flash-deals pl-5'><i className="fa fa-cart-arrow-down" aria-hidden="true"></i> Deals! Of The Day</h6>
        <br></br>
                    ...
                    {Products.map((items => {
                        return (<>
                            ...
                            <div className=' col-6 col-sm-6 col-lg-4 col-xl-3'>
                                ...
                                <img src="images/i-phone1.jpg" className='img-fluid' alt="prdcts_img"/>
